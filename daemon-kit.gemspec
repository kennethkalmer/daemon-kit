...
To get started quickly run 'daemon_kit' without any arguments
  ...
  s.test_files = ["test/test_generator_helper.rb", "test/test_cron_generator.rb", "test/test_nanite_agent_generator.rb", "test/test_daemon_kit_config.rb", "test/test_helper.rb", "test/test_amqp_generator.rb", "test/test_daemon-kit_generator.rb", "test/test_deploy_capistrano_generator.rb", "test/test_jabber_generator.rb"]
