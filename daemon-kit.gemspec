...
To get started quickly run 'daemon_kit' without any arguments
  ...
  s.test_files = ["test/test_daemon-kit_generator.rb", "test/test_generator_helper.rb", "test/test_jabber_generator.rb", "test/test_cron_generator.rb"]
